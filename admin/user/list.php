...
<div class="card card-outline rounded-0 card-indigo">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=user/manage_user" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> New User</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("Do you really want to delete this user?", "delete_user", [$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
