			...
			<form action="" id="manage-user">
				...
				<div class="form-group">
					...
					<?php if (isset($meta['id'])) : ?>
						<small><i>Leave this field blank if you do not wish to change the password.</i></small>
					<?php endif; ?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				<label for="room_name" class="control-label">Employee</label>
                    <select class="custom-select select2" name="room_name" id="room_name">
                        <?php 
